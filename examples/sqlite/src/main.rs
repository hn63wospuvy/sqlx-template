...
/// Tracing is automatically enabled when the "tracing" feature is active
/// All functions get #[instrument(name = "{fn_name}", skip_all)]
...
/// Example 2: Tracing automatically enabled
#[derive(SqliteTemplate, FromRow, Debug, Clone)]
#[table("orders")]
...
/// Example 3: Function-specific instrument override (can override default skip_all)
#[derive(SqliteTemplate, FromRow, Debug, Clone)]
#[table("logs")]
#[tp_select_all(by = "level", instrument = "skip(conn)")]  // Function-level override: skip only conn parameter
#[tp_select_one(by = "id")]  // Uses default skip_all
pub struct Log {
    #[auto]
    pub id: i32,
    pub level: String,
